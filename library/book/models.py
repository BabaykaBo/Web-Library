...
class Book(models.Model):
    ...
    authors = models.ManyToManyField(Author, through='AuthorBook', blank=True)
...
class AuthorBook(models.Model):
    ...
    def __str__(self):
        return f'Author: {self.author.name} {self.author.surname}; Book: {self.book.name}'
